                ...
                <div id="lifterlms-lesson-header">
                    ...
                    <div class="flex bb-position">
                        <div class="lifterlms-lesson-position">
							...
							?>
                            <span class="bb-pages">
                                <?php _e( 'Lesson ' . $current_lesson, 'buddyboss-theme' ); ?>
                                <span class="bb-total">
                                    <?php _e( ' of ' . $all_lesson_count, 'buddyboss-theme' ); ?>
                                </span>
                        ...
                        <div class="lifterlms-lesson-nav">
                            <div class="bb-ld-status">
								...
								if ( $progress == 100 ) {
									?>
                                    <div class="ld-status ld-status-complete ld-secondary-background">Complete</div>
								<?php
								} else { ?>
